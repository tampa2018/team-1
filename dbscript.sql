...
INSERT into posts(fbid, post_subject, body, num_likes, num_dislikes, category, time_stamp, campaign_year) values("2", "ideas ideas", "so much description", 1000, 4, "ideas", "time", "2018");
...
INSERT into comments(fbid, post_id, body, time_stamp) values("2", "1", "sammeeeee", "time");
